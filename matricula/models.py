...
from .constants import MESES, STATUS_MATRICULA, STATUS_MENSALIDADE, NAO_PAGO, INATIVA
from .managers import MensalidadeManager


class Matricula(models.Model):
    status = models.CharField(choices=STATUS_MATRICULA, max_length=2, default=INATIVA)
